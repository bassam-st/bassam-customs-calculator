...
(function(){
  ...
  (function applyFromQuery(){
    try{
      ...
      if (!isNaN(rateMul) && (rateMul===0.2075 || rateMul===0.265)) setRadioByValue(String(rateMul));
      else if (!isNaN(ratePct)) setRadioByValue(ratePct===5 ? '0.2075' : ratePct===10 ? '0.265' : '0.265');
...
/* حماية المالك… (نفس الكود الذي اعتمدناه سابقًا) */
